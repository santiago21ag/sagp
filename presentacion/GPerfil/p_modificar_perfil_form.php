            ...
            <div class="">
                ...
                <div  class="">
                    ...
                    <div class=" row d-flex justify-content-center m-0 p-0">
                        <div class="bg-danger col col-sm-12 col-md-12 col-lg-6 col-xl-6 p-3">
                            <h4 class="text-center display p-3 text-white">Editar informacion</h4>
                            <form   id="form_datos" method="POST" action="../../negocio/GPerfil/NPerfil.php" >
                                ...
                                <div class="row">
                                    <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6 col-lx-6">
                                    <div class="form-group pt-2 text-white">
                                ...
                                <div class="row">
                                    <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12">
                                        ...
                                        <button  class="btn btn-success text-center" id="modificar" onclick="" name="modificar">Aplicar cambios</button>
                                    </div>
                                </div>    
                            </form>
                        </div>
                    ...
                    <div class=" row d-flex  justify-content-center m-0 p-0">
                        <div class="colorcito bg-dark col col-sm-12 col-md-12 col-lg-5 col-xl-5 p-3">
                            <h4 class="text-center display p-3 text-white">Editar informacion</h4>
                            <form   id="form_datos" method="POST" action="../../negocio/GPerfil/NPerfil.php" >
                                <div class="row">
                                    <div class="form-group text-white col-12 col-sm-12 col-md-6 col-lg-6 col-lx-6">
                                        <label for="usuario">Usuario</label>
                                        <input type="text" class="form-control" id="usuario" name="usuario"  value="<?php echo $fila1[0][1];?>" required>
                                    </div>
                                    <div class="form-group text-white col-12 col-sm-12 col-md-6 col-lg-6 col-lx-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12 col-lx-12">
                                    <div class="d-flex justify-content-center">
                                        <button  class="btn btn-primary text-center text-white" id="modificar" onclick="" name="modificar">Aplicar cambios</button>
                                    </div>
                                </div>    
                            </form>
                        </div>

        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               ...
               <li class="menu-title text-center">panel de control</li>
                    ...
                    <li class=""><a href="p_modificar_perfil_form.php" > <i class="menu-icon fa fa-folder-open"></i>Modificar</a></li> 
    ...
    <div id="right-panel" class="right-panel">
        <header id="header" class="header">
            <div class="top-left">
                ...
                <div class=" text-danger spinner-grow-sm" role="status"><span class="sr-only">Loading...</span></div>
                </a>
                    <a class="navbar-brand hidden" href="../inicio_adm.php"><img src="../../estilo/iconos/balanza.png" alt="Logo"></a>

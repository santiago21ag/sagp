        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li class="menu-title text-center">panel de control</li>
                    ...
                    <li class="menu-title" style="font-size: 12px">G.Eventos/Fotografia</li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <div class="top-left">
                ...
                <a class="navbar-brand text-dark " style="font-size: 12pt;" href="inicio_a.php"><img src="../estilo/iconos/balanza.png" width="40" heigth="40" alt="Logo"><?php echo " ".$usuario;?>
                <div class=" text-success " role="status"><span class="sr-only">Loading...</span></div>
                </a>
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                <h5 class="text-center text-uppercase">Plataforma de Estudio Fotografico</h1>
                <div class="row d-flex  justify-content-center m-0 p-0">

                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                            <img src="../estilo/iconos/imagen3.jpg" class="d-block w-100" alt="imagen 3">
                            </div>
                            <div class="carousel-item">
                            <img src="../estilo/iconos/imagen2.jpg" class="d-block w-100" alt="imagen 2">
                            </div>
                            <div class="carousel-item">
                            <img src="../estilo/iconos/imagen1.jpg" class="d-block w-100" alt="imagen 1">
                            </div>
                        </div>
